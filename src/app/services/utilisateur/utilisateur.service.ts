...
export class UtilisateurService {
  ...
  getAllUsers(): Observable<Array<CreerUtilisateurModel>>{
    return this.http.get<Array<CreerUtilisateurModel>>(`${baseUrl}/Utilisateur/obtenir-tous-les-utilisateurs`)
  }

  // Method that calls api/User/get-user/{email} endpoint to get a user by using him or her email address

  getUser(id: string): Observable<CreerUtilisateurModel>{
    return this.http.get<CreerUtilisateurModel>(`${baseUrl}/Utilisateur/obtenir-utilisateur/${id}` )
  }
